      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <Card className="overflow-hidden shadow-strong">
            <CardContent className="p-8 text-center space-y-6 bg-gradient-to-b from-background to-accent/5">
              ...
              <p className="text-muted-foreground text-lg">{t("reviews.averageRating")}</p>
        ...
        <div className="text-center">
          <p className="text-muted-foreground">
            {t("reviews.averageFooter")}{" "}
            <span className="font-bold text-primary text-lg">5.0/5</span> {t("reviews.onGoogle")}
          </p>
        </div>
      </div>
    </section>
